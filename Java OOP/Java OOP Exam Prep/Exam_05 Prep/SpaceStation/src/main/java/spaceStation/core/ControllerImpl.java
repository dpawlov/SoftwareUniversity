...
public class ControllerImpl implements Controller {
    ...
    public String addAstronaut(String type, String astronautName) {
        //type -> Biologist, Geodesist, Meteorologist
        Astronaut astronaut;
        switch (type) {
            case "Biologist":
    ...
    public String report() {
        ...
        builder.append(String.format(ConstantMessages.REPORT_PLANET_EXPLORED, countExploredPlanets)).append(System.lineSeparator());
        ...
        this.astronautRepository.getModels().forEach(a -> {
            ...
            builder.append(String.format(ConstantMessages.REPORT_ASTRONAUT_OXYGEN, a.getOxygen())).append(System.lineSeparator());
            ...
            if (a.getBag().getItems().size() == 0) {
                ...
                builder.append(String.format(ConstantMessages.REPORT_ASTRONAUT_BAG_ITEMS, String.join(", ", items))).append(System.lineSeparator());
            }
        });
